...
public class Game2Handler extends Thread {
	private BufferedReader reader;
	private PrintWriter writer;
	private Socket socket;
	private List<Game2Handler> list;
	private String nickName;

	public Game2Handler(Socket socket, List<Game2Handler> list) throws IOException {
	...
	public void broadcast(String mag) throws ConcurrentModificationException{
		if (list.size() > 0) {
			for (Game2Handler handler : list) { // list안에 있는 ChatHandler을 하나씩 꺼내서 하나씩 보낸다.
