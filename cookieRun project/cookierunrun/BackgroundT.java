...
class BackgroundT extends JPanel implements Runnable{
	...
	public void paintComponent(Graphics g) {
		...
		if(gamingTime==20&&round2==false) Round2Music();
		//게임이 시작된 지 60초가 지났을 때 배경 체인지
		if(gamingTime==20&&round2==false) round2=true;
