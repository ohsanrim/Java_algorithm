...
public class Room5Handler extends Thread {
	private BufferedReader reader;
	private PrintWriter writer;
	private Socket socket; // 서버에서 만들어진 소켓을 받기 위함이다. 소켓하나하나에는 reader와 writer가 있어야 한다.
	private List<Room5Handler> list;
	public String nickName;

	public Room5Handler(Socket socket, List<Room5Handler> list) throws IOException {
		this.socket = socket;
		this.list = list;
